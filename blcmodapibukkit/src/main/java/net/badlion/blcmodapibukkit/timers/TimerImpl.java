...
public class TimerImpl implements Timer {
	...
	public TimerImpl(BlcModApiBukkit plugin, long id, String name, ItemStack item, boolean repeating, long time) {
		this.plugin = plugin;
		this.id = id;
		this.name = name;
		this.item = item;
	...
	public TimerImpl(BlcModApiBukkit plugin, int id, String name, ItemStack item, boolean repeating, long time, TimeUnit timeUnit) {
		this.plugin = plugin;
		this.id = id;
		this.name = name;
		this.item = item;
